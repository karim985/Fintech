...
print(f"the total of all loans is: {total_of_all_loans}")
...
print(f"the average of loan price is: {average_loan_price}")
...
#from practice import Present_Value
...
# YOUR CODE HERE!
def final_price(future_value, remaining_months, annual_discount_rate):
    Present_Value = present_value = future_value / (1 + (annual_discount_rate/12)) ** remaining_months
    return present_value

# @TODO: Use the function to calculate the present value of the new loan given below.
#    Use an `annual_discount_rate` of 0.2 for this new loan calculation.
# YOUR CODE HERE!
Present_Value = final_price(remaining_months = 12, annual_discount_rate = 0.20, future_value = 1000)
...
inexpensive_loans = [loan["loan_price"] for loan in loans
